...
export default function Pillars() {
  return (
    <section id="pillars" className="py-24 bg-dark-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pillars.map((pillar, index) => (
            ...
            >
              <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${pillar.color} flex items-center justify-center mb-4 text-white`}>
                {pillar.icon}
              </div>
