...
export default function PlaybookFinalCTA() {
  return (
    <section
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        <h2
          id="playbook-final-cta-heading"
          className="text-3xl md:text-5xl font-bold mb-6"
        >
          Want advice like this,{" "}
          <span className="gradient-text-shimmer">in real time?</span>
        </h2>

        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          Join Benjamin and hundreds of other Asian men sharing field-tested
          insights every day in the community.
        </p>
        ...
        <a
          ...
          onClick={() =>
            window.plausible?.("Playbook CTA Click", {
              props: { variant: "final" },
            })
          }
